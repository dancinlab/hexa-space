<!-- @canonical: n6-architecture@0570a835:domains/space/aerospace/aerospace.md -->
<!-- @extracted: 2026-05-06 -->
<!-- @md5_at_extraction: 7f5d0ad3cd1ea0018a87f3ec66cd6ead -->
...
| Effect | Current (2026) | After HEXA-AERO (target) | n=6 rationale |
|------|-------------|--------------|---------|
...
### Performance comparison ASCII bars (legacy vs HEXA-AERO)
...
## §X BLOWUP — aerospace breakthrough pattern (2026-04-19)
...
|------|-----------|-----------|----------|
| sonic | 1 | 1 = φ/φ | φ/φ=1 |
| supersonic | ~2 | φ = 2 | prime factor |
| hypersonic | ~5 | sopfr = 5 | prime-factor sum |
...
|--------|----------|----------|----------|
| civil transport | 0.3 | 1/n = 0.17 | 1/n |
...
| 2 | Mach air-breathing wall | σ-φ | 10 |
| 3 | η_Brayton (sCO₂) | σ·τ% | 48% |
| 4 | T/W fusion dual | sopfr | 5 |
...
### §X.6 atlas constant outputs (7 items)
